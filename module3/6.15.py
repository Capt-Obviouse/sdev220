...
def computeTax(status, taxableIncome):
    ...
    if status == 0:
        ...
        sys.exit()
    print(format(tax, "<25.0f"), end = ' ')

string = ["Taxable Income", "Single", "Married Joint", "Married Separate", "Head of a House"]

for x in string:
    print(format(x, "<25"), end = ' ')
print()
for x in range(50000, 60050, 50):
